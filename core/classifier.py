...
def classify(client, user_input: str) -> dict:
    """LLM만으로 분류 (키워드 매핑 제거)"""
...
1. 구체화 완료(is_complete=true)이고 유형이 건의인 경우:
   - 내용을 한 줄로 요약해서 "아래 내용으로 접수할게요!" 라고 안내하세요
...
def get_ai_response(client, messages: list[dict], classify_result: dict) -> str:
